...
int		main()
{
	...
	for (std::vector<int>::const_iterator it = vec1.begin(); it != vec1.end(); it++)
		std::cout << "|"<< *it << "| ";
	std::cout << std::endl;
	...
	for (std::vector<int>::const_iterator it = vec1It.begin(); it != vec1It.end(); it++)
	   std::cout << "|"<< *it << "| ";
	std::cout << std::endl;

	std::cout << "construct copy:" << std::endl;
	std::vector<int>	vec1Copy(vec1);
	for (std::vector<int>::const_iterator it = vec1Copy.begin(); it != vec1Copy.end(); it++)
	   std::cout << "|"<< *it << "| ";
	std::cout << std::endl;
	...
	vec1op.reserve(22);
	vec1op = vec1;
	for (std::vector<int>::const_iterator it = vec1op.begin(); it != vec1op.end(); it++)
	   std::cout << "|"<< *it << "| ";
	std::cout << std::endl;
