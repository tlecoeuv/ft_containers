...
/*   Updated: 2020/12/09 17:11:14 by rofernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <class T>
void	print_content(ft::queue<T> que)
{
...
template <class T>
void	print_access(ft::queue<T> que)
{
	std::cout << "que.front(): " << que.front() << std::endl;
...
int main(void)
{
	std::cout << "################# TESTS MY QUEUE #################" << std::endl;
